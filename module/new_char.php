        ...
        <form action="" method="post" id="FormCreate">
            ...
            <span class="step-4">
                ...
                <span id="show-perso">
                    ...
                    <br>
                    <textarea name="caractere" maxlength="2000" minlength="500" id="cara_t" ><?=(isset($dataUseDefault['caractere'])) ? $dataUseDefault['caractere'] : ""?></textarea>
                    <br><span id="cara_c" class="not"></span>
                    <br><br>
                    <label>Ton objectif ?</label>
                    <br>
                    <textarea name="objectif" maxlength="2000" minlength="500" id="obj_t"placeholder="Devenir un grand magicien et tous savoir du monde" ><?=(isset($dataUseDefault['objectif'])) ? $dataUseDefault['objectif'] : ""?></textarea>
            ...
            <span class="step-6">
                ...
                <input name="donName" placeholder="Maître des âmes" style="width: 15em;text-align: center;" <?=(isset($dataUseDefault['donName'])) ? "value='{$dataUseDefault['donName']}'" : ""?>>
                <br>
                <br>
            ...
            <span class="step-7">
                ...
                <div id="show-donEveil">
                    ...
                    <br>
                    <textarea  name="donEveil" maxlength="2000" minlength="30" id="done_t" placeholder="Suite à son éveil, l'utilisateur gagnera la capacité de rentrer en contact avec les âmes et d'utiliser la sienne&#10;&#10;celà lui permet de créer des attaques basés sur son âme, mais aussi de manipuler ou sentir ce qui se passe proche de lui, à condition d'être concentré."><?=(isset($dataUseDefault['donEveil'])) ? $dataUseDefault['donEveil'] : ""?></textarea>
            ...
            <span class="step-8">
                ...
                <div id="show-donTranscendance">
                    ...
                    <br>
                    <textarea name="donTranscendance" maxlength="2000" minlength="30" id="dont_t" placeholder="Maintenant l'âme et le corps de l'utilisateur ne font plus qu'un, lui permettant de légèrement plané, de passer au travers la matière non magique voir même de puissé dans la puissance de son âme pour gagner une force terrifiante."><?=(isset($dataUseDefault['donTranscendance'])) ? $dataUseDefault['donTranscendance'] : ""?></textarea>
